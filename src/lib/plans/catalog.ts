...
export const PLAN_CATALOG: Record<PlanId, PlanDefinition> = {
  free: {
    ...
    exportsPerHour: envNumber("EXPORT_RATE_LIMIT_PER_HOUR", 40),
    exportFormats: ["SVG", "Transparent PNG", "Hi-res PNG", "Icon", "Horizontal", "Stacked", "Monochrome", "ZIP Brand Kit"],
    maxProjects: null,
    brandKitAccess: true,
  ...
  pro: {
    ...
    conceptsPerGeneration: 4,
    exportsPerHour: envNumber("EXPORT_PRO_RATE_LIMIT_PER_HOUR", 200),
    exportFormats: ["SVG", "Transparent PNG", "Hi-res PNG", "Icon", "Horizontal", "Stacked", "Monochrome", "ZIP Brand Kit"],
    maxProjects: null,
    brandKitAccess: true,
    ...
    signedOutCta: {
      label: BILLING_PROVIDER_CONNECTED ? "Notify me" : "Join waitlist",
