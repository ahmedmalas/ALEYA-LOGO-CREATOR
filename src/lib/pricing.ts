...
export const PLANS: Plan[] = [
  {
    ...
    generationLimit: "20 logo generations per hour",
    exportLimit: "3 Brand Kit ZIP downloads per day",
    features: [
  ...
  },
  {
    ...
    generationLimit: "200 logo generations per hour",
    exportLimit: "Unlimited Brand Kit ZIP downloads",
    features: [
      "Everything in Free",
      "Priority generation queue",
      "Unlimited active Brand Kits",
